...
int main() 
{ 
cout<<"Name :Manaswi katkar , Class : SE , Batch : A3 , Roll no.: 23139"<<endl; 
Lineclip lc; 
int gd = DETECT,v,gm; 
...
delay(2000); switch(v) { case 0: lc.drawwindow();
 delay(2000); lc.drawline(p1,p2); 
break; 
...
void Lineclip::drawline(Coordinate p1,Coordinate
 p2) 
{ 
...
ptemp.x=p.x; 
ptemp.y=p.y;
 return(ptemp); }; int Lineclip:: visibility(Coordinate
 p1,Coordinate p2) 
{ 
int i,flag=0; 
for(i=0;i<4;i++) 
...
Coordinate Lineclip::resetendpt(Coordinate p1,Coordinate
 p2) 
{ 
Coordinate temp; 
int x,y,i; 
